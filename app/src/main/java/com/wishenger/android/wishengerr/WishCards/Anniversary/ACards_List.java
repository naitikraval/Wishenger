package com.wishenger.android.wishengerr.WishCards.Anniversary;
...
public class ACards_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acards__list);
...
//        actionBar.setTitle("Wish Cards");
        ...
        mRef = mFirebaseDatabase.getReference("AnniversaryCards");
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists())
                {
                    ...
                    Toast.makeText(ACards_List.this, "No Data Available", Toast.LENGTH_SHORT).show();
                }
...
//                                 byte[] bytes=stream.toByteArray();
    ...
    public void CheckInternet() {
        if (!isNetworkAvailable()) {
            Intent NoInternetIntent = new Intent(ACards_List.this, InternetActivity.class);
