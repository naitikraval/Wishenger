package com.wishenger.android.wishengerr.WishCards.Special;
...
public class Cards_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cards__list);
...
//        actionBar.setTitle("Wish Cards");
        ...
        mRef = mFirebaseDatabase.getReference("Cards");
        showData();
...
//        //set layout
    ...
    public void CheckInternet() {
        if (!isNetworkAvailable()) {
            Intent NoInternetIntent = new Intent(Cards_List.this, InternetActivity.class);
