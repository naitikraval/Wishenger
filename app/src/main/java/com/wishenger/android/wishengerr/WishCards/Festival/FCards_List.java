package com.wishenger.android.wishengerr.WishCards.Festival;
...
public class FCards_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fcards__list);
...
//        actionBar.setTitle("Wish Cards");
        ...
        mRef = mFirebaseDatabase.getReference("FestivalCards");
        showData();
...
//                                 byte[] bytes=stream.toByteArray();
    ...
    public void CheckInternet() {
        if (!isNetworkAvailable()) {
            Intent NoInternetIntent = new Intent(FCards_List.this, InternetActivity.class);
