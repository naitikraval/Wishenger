package com.wishenger.android.wishengerr.WishCards.Friendship;
...
public class Fr_cards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fr_cards);
...
//        actionBar.setTitle("Wish Cards");
        ...
        mRef = mFirebaseDatabase.getReference("Friendship");
        showData();
...
//                                 byte[] bytes=stream.toByteArray();
    ...
    public void CheckInternet() {
        if (!isNetworkAvailable()) {
            Intent NoInternetIntent = new Intent(Fr_cards.this, InternetActivity.class);
